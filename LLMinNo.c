...
int SinglyLLMinimum(PNODE Head )
{
    int Min=0,i=1,size=0;
    size=Count(Head);
    Min =Head->data;
...
int main()
{
    ...
    while (iChoice !=0)
    {
        ...
        printf("4 : Find Minimum Number from LinkedList\n");
    ...
    case 4:
        iRet=SinglyLLMinimum(first);
        printf("Minimum Number from LinkedList is :%d\n",iRet);
        break;
