...
int main()
{
    ...
    while (iChoice !=0)
    {
        ...
        printf("4 : Search Last Occureence of element\n");
    ...
    case 4:
        printf("Enter element to Check Last Occurrence in LinkedList\n");
        scanf("%d",&value);
        iRet=SearchLastOcc(first,value);
        printf("Last Occurence of %d at Position :%d",value ,iRet);
        break;
