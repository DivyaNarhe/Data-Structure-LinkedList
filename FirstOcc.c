...
int main()
{
    ...
    while (iChoice !=0)
    {
        ...
        printf("4 : Search First Occureence of element\n");
    ...
    case 4:
        printf("Enter element to Check First Occurrence in LinkedList\n");
        scanf("%d",&value);
        iRet=SearchFirstOcc(first,value);
        printf("First Occurence of %d at Position :%d",value ,iRet);
        break;
