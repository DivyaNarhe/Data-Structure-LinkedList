...
void  SinglyLLSumDigit(PNODE Head )
{
    int sum=0,i=0,size=0,iDigit=0,temp=0;
...
int main()
{
    ...
    while (iChoice !=0)
    {
        ...
        printf("4 : Display Addition of all Even elements present in LinkdeList\n");
